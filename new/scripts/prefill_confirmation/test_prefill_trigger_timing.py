#!/usr/bin/env python3
"""
test_prefill_trigger_timing.py
...
added to run_prefill_trigger_sweep.py. Imports the functions under test
...
Usage:
    python3 test_prefill_trigger_timing.py
"""
...
import run_prefill_trigger_sweep as runner  # noqa: E402
...
def main() -> int:
    print("test_prefill_trigger_timing.py -- offline timing/wave/trigger instrumentation tests")
    print("=" * 78)
