...
PYTHON_RUNNER="${SCRIPT_DIR}/run_prefill_trigger_sweep.py"
...
LOGDIR="${PROJECT_ROOT}/new/logs/prefill_trigger_sweep"
mkdir -p "$LOGDIR"
TIMESTAMP="$(date -u +%Y%m%dT%H%M%SZ)"
LOGFILE="${LOGDIR}/run_prefill_trigger_sweep_${TIMESTAMP}_pid${BASHPID}.log"
: > "$LOGFILE"
